...
discName2='TightMuonRejectionAllHits'
discriminator2="hpsPFTauDiscriminationBy"+discName2

discName='MediumMuonRejectionAllHits'
discriminator="hpsPFTauDiscriminationBy"+discName


discNameLoose3='LooseMuonRejection3'
...
#medium
discNameMedium3='TightMuonRejection3'
...
process.tauMuAnalyzer = process.tauDifferenceAnalyzer.clone ( Zmumu = cms.bool(True),
...
process.hpsPFTauDiscriminationByLooseMuonRejection.maxNumberOfMatches = cms.int32(1)
process.hpsPFTauDiscriminationByMediumMuonRejection.maxNumberOfMatches = cms.int32(1)
process.hpsPFTauDiscriminationByTightMuonRejection.maxNumberOfMatches = cms.int32(1)

process.hpsPFTauDiscriminationByMediumMuonRejection.checkNumMatches = cms.bool(True)
process.hpsPFTauDiscriminationByTightMuonRejection.checkNumMatches = cms.bool(True)

process.hpsPFTauDiscriminationByMediumMuonRejectionAllHits = process.hpsPFTauDiscriminationByMediumMuonRejection.clone( maxNumberOfMatches = cms.int32(0))
process.hpsPFTauDiscriminationByTightMuonRejectionAllHits = process.hpsPFTauDiscriminationByTightMuonRejection.clone( maxNumberOfMatches = cms.int32(0))

process.produceAndDiscriminateHPSPFTaus.replace(
    process.hpsPFTauDiscriminationByTightMuonRejection,
    process.hpsPFTauDiscriminationByTightMuonRejection*
    process.hpsPFTauDiscriminationByMediumMuonRejectionAllHits*
    process.hpsPFTauDiscriminationByTightMuonRejectionAllHits
 )
